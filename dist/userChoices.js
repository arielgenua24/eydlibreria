...
function userChoicesRecomendations() {
    ...
    const firstRowFather = document.querySelector('.div__firstRow--container');
    const secondRowFather = document.querySelector('.div__secondRow--container');
    ...
    const marketingRecomendations = document.querySelector('.class__button--marketing');
